      ...
      <main className="mb-4 container">
        ...
        <div className=" d-flex flex-column align-items-center text-center my-4">
          ...
          <div className="d-flex">
            <CSVUploader
              loadedHandler={handleUploadIntraday}
              removeHandler={() => setLoaded({ ...loaded, intraday: false })}
              header="Intraday CSV"
            ...
            <CSVUploader
              ...
              header="Intervals Chart CSV"
              label="Insert Intervals Chart CSV"
            />
          </div>
        </div>
        <div className="container d-flex flex-column align-items-center text-center my-2">
          ...
          <div className="d-flex align-items-center my-2">
            <button
              ...
              onClick={handleGenerateIntraday}
              disabled={entries.type !== "intraday" || !selected.date}
            >
              Generate Intraday
            </button>
